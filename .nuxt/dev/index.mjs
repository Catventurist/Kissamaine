...
const serverAssets = [{"baseName":"server","dir":"C:/Users/M/Coding/Kissamaine/server/assets"}];
...
storage.mount('pinceau', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\M\\Coding\\Kissamaine\\.nuxt\\pinceau\\theme","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"C:\\Users\\M\\Coding\\Kissamaine\\content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"C:\\Users\\M\\Coding\\Kissamaine\\.nuxt\\content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\M\\Coding\\Kissamaine","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"C:\\Users\\M\\Coding\\Kissamaine\\server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\M\\Coding\\Kissamaine\\.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"C:\\Users\\M\\Coding\\Kissamaine\\.nuxt\\cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _qkX77bZVcZ = (function(nitro) {
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file://C:/Users/M/Coding/Kissamaine/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _MZZM4W = defineEventHandler(async (event) => {
...
const _DnWJgU = defineEventHandler(async (event) => {
...
const _zD6Gok = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_6g5OoL = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_6g5OoL, lazy: true, middleware: false, method: undefined },
  { route: '/api/_content/query/:qid/**:params', handler: _MZZM4W, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query/:qid', handler: _MZZM4W, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/query', handler: _MZZM4W, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/cache.json', handler: _DnWJgU, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid/**:params', handler: _zD6Gok, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation/:qid', handler: _zD6Gok, lazy: false, middleware: false, method: "get" },
  { route: '/api/_content/navigation', handler: _zD6Gok, lazy: false, middleware: false, method: "get" },
  { route: '/**', handler: _lazy_6g5OoL, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file://C:/Users/M/Coding/Kissamaine/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('file://C:/Users/M/Coding/Kissamaine/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
